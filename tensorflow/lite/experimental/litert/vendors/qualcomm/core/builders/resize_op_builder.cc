...
std::vector<OpWrapper> BuildResizeOp(
    ...
    const char* align_corner_param, const char* half_pixel_center_param,
  ...
  resize_op.AddScalarParam<bool>(align_corner_param, align_corners);
  resize_op.AddScalarParam<bool>(half_pixel_center_param, half_pixel_centers);
